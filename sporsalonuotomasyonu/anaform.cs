using sporsalonuotomasyonu.Properties;
...
namespace sporsalonuotomasyonu
{
    public partial class AnaForm : Form
    {
        ...
        private void panelsec(object sender, EventArgs e)
        {
            ...
            Panel[] tumPaneller = { pnl1, pnl2, pnl3, pnl4 };
        ...
        #region Ge#region GeriButonResim
        ...
        {
            loginbtn.Location = new Point(540, 280);
            loginbtn.Width = 80;
            loginbtn.Height = 52;
            ...
            try
            {
                    ...
                    var values = new Dictionary<string, string>
               {
                ...
                { "end_date", Convert.ToDateTime(cikisdate.Text).ToString("yyyy-MM-dd") }
                    ...
                    {
                        ploading.Visible = false;
                        MessageBox.Show("Yeni kullanýcý baþarýyla eklendi", "Baþarýlý", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        MessageBox.Show("Kiþi eklenemedi", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    tad.Text = "";
                    tmail.Text = "";
                    mtel.Text = "";
                ...
                {
                    MessageBox.Show("Yanlýþ veya Hatalý Mail");
                }
        ...
        private async void btn2_Click(object sender, EventArgs e)
        {
            ...
            listeledata.Columns[2].HeaderText = "Telefon";
            listeledata.Columns[3].HeaderText = "E-Mail";
            listeledata.Columns[4].HeaderText = "Baþlangýç Tarihi";
            listeledata.Columns[5].HeaderText = "Bitiþ Tarihi";
        ...
        private async void btnsil_Click(object sender, EventArgs e)
        {
            try
            {
                DialogResult a = MessageBox.Show(sec + " kiþisi silmek istediðinize emin misiniz.", "Sil", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                ploading.Visible = true;
                if (a == DialogResult.Yes)
                {
                    ...
                    if (response.durum == true)
                    {
                        ...
                        listeledata.Columns[3].HeaderText = "E-Mail";
                        ploading.Visible = false;
                        MessageBox.Show("Kiþi baþarýyla silindi.", "Baþarýlý", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        sec = "";
                        secilen = "";
                    }
                    else
                    {
                        ploading.Visible = false;
                        MessageBox.Show("Kiþi silinemedi", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                            ...
                            var values4 = new Dictionary<string, string>
                        {
                                ...
                                var values5 = new Dictionary<string, string>
                            {
                                    ...
                                    var values6 = new Dictionary<string, string>
                                {
                                    ...
                                    {
                                        MessageBox.Show("Diyet baþarýyla eklendi", "Baþarýlý", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                        ploading.Visible = false;
                                        kahvaltiTxt.Text = "";
                                        kahvaltiDate.Text = "";
                                        kuslukTxt.Text = "";
        ...
        private async void egguncel_Click(object sender, EventArgs e)
        {
                ...
                var values = new Dictionary<string, string>
            {
                ...
                {
                    MessageBox.Show("Güncelleme Baþarýsýz", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        private async void btnYenile_Click(object sender, EventArgs e)
        {
                ...
                var values = new Dictionary<string, string>
            {
                ...
                if (response)
                {
                    MessageBox.Show("Þifreniz deðiþtirildi.", "Baþarýlý", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ploading.Visible = false;
                    txteskiParola.Text = "";
                    txtyeniParola.Text = "";
                    txtyeniTekrar.Text = "";
                ...
                {
                    MessageBox.Show("Þifreniz deðiþtirilemedi.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        private async void diyettur_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (Diyetdegis == false)
                {
                    ...
                    if (kahvaltiTxt.Text == "")
                    {
                        kahvaltiTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                    if (kuslukTxt.Text == "")
                    {
                        kuslukTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                    if (ogleTxt.Text == "")
                    {
                        ogleTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                    if (ikindiTxt.Text == "")
                    {
                        ikindiTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                    if (aksamTxt.Text == "")
                    {
                        aksamTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                    if (araTxt.Text == "")
                    {
                        araTxt.Text = "Bu öðünde yiyeceðiniz bulunmamaktadýr.";
                    }
                }
        ...
        private async void egsil_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult a = MessageBox.Show(sec + " egzersizi silmek istediðinize emin misiniz.", "Sil", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                ploading.Visible = true;
                egkaydet.Enabled = false;
                egguncel.Enabled = false;
                egsec.Enabled = false;
                ...
                if (a == DialogResult.Yes)
                {
                    ...
                    if (response.durum == true)
                    {
                        ...
                        egdata.Columns[5].HeaderText = "Tekrar";
                        ploading.Visible = false;
                        MessageBox.Show("Egzersiz baþarýyla silindi.", "Baþarýlý", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ploading.Visible = false;
                        egkaydet.Enabled = true;
                        egguncel.Enabled = true;
                        g4.Enabled = true;
